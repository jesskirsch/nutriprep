...
RECIPES = [
  ...
  {  name: "Tuna Nicoise Salad",
    instructions: "	1.	Bring a medium pot of water to boil. Add beans and cook until bright green and crisp-tender, about 2 minutes. Drain and plunge beans into ice water. Drain and set aside.
	2.	Arrange lettuce, basil, tomatoes, onion, cucumbers, radishes, eggs and green beans evenly between two plates.
	3.	Heat a large nonstick skillet over medium-high heat. Coat pan with cooking spray. Sprinkle tuna with salt and pepper. Add tuna to pan and cook until browned on the outside but still pink inside, about 2 minutes on each side. Cut thinly across the grain. Arrange tuna over vegetables.
	4.	To prepare dressing, combine lemon juice and the rest of the ingredients in a small jar with a tight fitting lid. Shake until well combined and drizzle evenly over salads.",
    category: "breakfast",
    vegan: false,
    paleo: true,
    basic:false,
  ...
  {  name: "Paleo Mini Bagels",
    instructions: "	1.	In a food processor, pulse almond flour, flax meal, coconut flour, baking soda, and salt
	2.	Add eggs, and vinegar and pulse until thoroughly combined
	3.	Fit a pastry bag with a ⅜-inch round tip and fill bag with batter
	4.	Pipe into a mini donut pan
	5.	Sprinkle bagels with poppy seeds, sesame seeds, and onion flakes
	6.	Bake at 350° for 14-17 minutes, until a toothpick inserted into the center of a bagel comes out clean
	7.	Let bagels cool in the pan for 10 minutes.",
    category: "breakfast",
    vegan: false,
    paleo: true,
    basic:false,
  ...
  {  name: "Gluten free blueberry and coconut scones",
    instructions: "	Preheat oven to 350F. Line a 9 inch round baking pan with unbleached parchment paper all the way up to the sides of the baking pan, just like in the pictures. Set aside.
...
Let the scones cool for at least 15 minutes. Pulling from the parchment paper, lift the scones up from the pan and cut into 8 pieces. You can store them on a cake stand for up to two days.",
  ...
  {  name: "Paleo Chinese Chicken Salad",
    instructions: "	1.	For the dressing: In a small mason jar with lid, add tamari, vinegar, minced ginger, olive oil, hoisin sauce, toasted sesame oil, chili oil, siracha, sea salt and chopped green onions. Secure the lid on top and shake vigorously. Set aside.
  ...
  {  name: "Butternut Squash Soup Recipe",
    instructions: "	1.	Heat oven to 450° F. Toss the squash and onion with 1 teaspoon oil and salt on a rimmed baking sheet. Roast in a single layer until browned and soft, about 25-30 minutes, stirring occasionally.
  ...
  {  name: "Baked Tilapia with Radish Relish Recipe",
  ...
  {  name: "Steak with Chimichurri Sauce Recipe",
    instructions: "	1.	Heat the grill to medium-high and season the steak with some salt and pepper.
	2.	In a food processor, pulse together the rest of the ingredients and set aside in a small bowl.
	3.	Grill the steak until the meat is charred on the outside and rare within, about 2-3 minutes per side. Transfer to a carving board and let rest for 5 minutes.
	4.	Thinly slice the steak across the grain. Serve right away with the chimichurri sauce.",
    category: "dinner",
    vegan: false,
    paleo: true,
    basic:false,
  ...
  {  name: "Chopped Chickpea salad",
    instructions: "1.	Add all your ingredients to a large mixing bowl and stir with a wooden spoon until all ingredients are combined. Taste and adjust flavors as needed.",
    category: "snack",
    vegan: false,
    paleo: true,
    basic:false,
  ...
  {  name: "Ahi Poke",
    instructions: "Pat the ahi dry, then neatly cut it into small 1/2-inch cubes. Place in a large bowl. Add the shallots, green onion, soy sauce, sesame oil, chili garlic sauce, capers and sesame seeds and gently toss to mix well. Drizzle with spicy avocado dressing (optional). Serve immediately or cover and refrigerate. This recipe will make 6- 8 appetizer portions or 3 meal sized portions.
You can serve your Poke with fresh guacamole and blue corn chips or simply enjoy on it’s own! This is a wonderful recipe that is not only healthy and delicious but also incredibly easy to make! You can impress guests at a dinner party by serving this elegant dish as an appetizer in mini glass bowls with a sprig of fresh parsley and lime wedge as garnish! ",
    category: "snack",
    vegan: false,
    paleo: true,
    basic:false,
  ...
  {  name: "Sweet Potato Fries",
    instructions: "Cut sweet potatoes into wedges, you can make these small or large according to your preferences.  I like cutting them a little thiner so they are nice and crispy
In a Ziploc bag, toss sweet potato wedges with coconut oil and spices.  Arrange coated wedges on a baking tray or aluminum foil and sprinkle with coarse sea salt.  Bake at 400deg for 30mins or until the outside is somewhat crispy and the inside is soft. Serve with organic ketchup or sauce of choice.",
  ...
  {  name: " Vanilla Muffin and cinnamon",
    instructions: "Place all dry ingredients in a coffee mug.  Stir to combine. 
	Add the egg and oil.  Stir until thoroughly combined.  
	Microwave for 1 minute. Use a knife if necessary to help remove the muffin from the cup, slice,  and add butter.",
    category: "breakfast",
    vegan: false,
    paleo: false,
    basic: true,
  ...
  {  name: "Blackberry Drink",
    instructions: "For this recipe unsweetened coconut, almond or soy milk may be used.  
Combine the frozen blackberries, milk of choice, protein powder, flax meal , vanilla and spices in a blender.  Blend until smooth.",
    category: "breakfast",
    vegan: false,
    paleo: false,
    basic: true,
  ...
  {  name: "Salad with arugula and gorgonzola",
    instructions: "Use the recipe to make Maple-Dijon Vinaigrette for this recipe.  You will need 4 Tbsp. This salad is delicious served with salmon.
  ...
  {  name: "Cantonese salad",
    instructions: "In a large saucepan, bring broth and tamari to a boil.
